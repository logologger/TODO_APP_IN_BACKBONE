...
template:_.template($("#task_items").html()),
  ...
  events:{
    ...
    'click #download_txt':'download_txt'
  ...
  delete_the_task:function()
  {
    ...
    //unitl the user enter Ok otherwise it not delete the model------the adjacent statement is false
    this.model.destroy(
      {
        success:function()
        {
  ...
  // console.log(anchor);
  // anchor.href='data:text/plain;charset=utf-8,'+encodeURIComponent(this.model.get('task'));
  // anchor.download='task.txt';
